...
This document records the reproducible quality gate for DestinX AI Commerce 0.8.0. Measurements are development-environment reference values, not hosting guarantees.
