...
final class Issue_Catalog {
	...
	public static function label( $code ) {
		$labels = array(
			...
			'variations_not_purchasable'      => __( 'No purchasable variations', 'destinx-ai-commerce' ),
			'variation_prices_missing'        => __( 'Variation prices incomplete', 'destinx-ai-commerce' ),
			'variation_attributes_incomplete' => __( 'Variation attributes incomplete', 'destinx-ai-commerce' ),
			'product_not_purchasable'         => __( 'Product is not purchasable', 'destinx-ai-commerce' ),
			'stock_status_unknown'            => __( 'Stock status is not recognized', 'destinx-ai-commerce' ),
		);
	...
	public static function guidance( $code ) {
		$guidance = array(
			...
			'variations_not_purchasable'      => __( 'Review the variation status, price, and configuration until at least one variation can be purchased.', 'destinx-ai-commerce' ),
			'variation_prices_missing'        => __( 'Set a valid regular or sale price on every enabled variation.', 'destinx-ai-commerce' ),
			'variation_attributes_incomplete' => __( 'Assign explicit attribute values to each variation so it can be identified unambiguously.', 'destinx-ai-commerce' ),
			'product_not_purchasable'         => __( 'Review the product status, price, type, and WooCommerce configuration that prevents purchasing.', 'destinx-ai-commerce' ),
			'stock_status_unknown'            => __( 'Select a standard WooCommerce stock status: in stock, out of stock, or on backorder.', 'destinx-ai-commerce' ),
		);
